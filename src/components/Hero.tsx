  ...
  return (
    <section id="home" className="relative min-h-screen flex items-center pt-16 overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        ...
        <div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-secondary/30 rounded-full filter blur-2xl animate-float" style={{ animationDelay: "2s" }}></div>
        <div className="absolute top-1/2 left-1/2 w-64 h-64 bg-accent/20 rounded-full filter blur-xl animate-float" style={{ animationDelay: "3s" }}></div>
      </div>
