  ...
  const projects = [
    {
      ...
      description:
        "A comprehensive dashboard for monitoring environmental data with real-time analytics and interactive visualizations.",
    ...
    },
    {
      ...
      description:
        "An AI-powered personal assistant with natural language processing capabilities for task management.",
    ...
    },
    {
      ...
      description:
        "Secure and transparent voting platform built on blockchain technology ensuring tamper-proof elections.",
    ...
    },
    {
      ...
      description:
        "A mobile application that integrates various transportation methods for efficient city navigation.",
    ...
    },
    {
      ...
      description:
        "IoT wearable device with companion app for real-time health monitoring and data analysis.",
    ...
    },
    {
      ...
      description:
        "Educational platform using augmented reality to enhance the learning experience for STEM subjects.",
